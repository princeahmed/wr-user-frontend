    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#fff">
        ...
        <tr>
            <td height="25" style="background:#222;padding:15px 5%;font-size:1px;border-collapse:collapse;margin:0">
                <p style="margin-top:0;margin-bottom:0">
                    <span style="color:#fff;font-size:20px;font-family:inherit;font-weight:bold;text-transform:uppercase;text-decoration:initial;line-height:40px;letter-spacing:normal">New Station Submission:</span>
                </p></td>
        </tr>
        ...
        <tr>
            <td valign="top" style="color:#595959;font-size:15px;font-family:HelveticaNeue,Roboto,sans-serif;font-weight:initial;text-transform:initial;text-decoration:initial;line-height:22px;letter-spacing:normal;padding:5%;margin-bottom:1rem;background:#fff">
                <div>
                    ...
                    <p dir="ltr" style="margin-top:0;margin-bottom:0;margin-left:0;margin-right:0">New station submission is waiting for your confirmation:</p>
        ...
        <tr>
            <td align="center" height="35" style="border-collapse:collapse">
                <a rel="noopener" href="<?php echo add_query_arg( [ 'action' => 'view_station_submission', 'id' => $post_id ],
					admin_url() ); ?>" style="background:#cc4d29;border-radius:3px;color:#fff!important;font-size:11px;font-weight:600;padding:11px 10px;text-align:center;text-decoration:none;text-transform:uppercase;white-space:nowrap" target="_blank">View Details</a>
                <a rel="noopener" href="<?php echo add_query_arg( [
					'action' => 'view_station_submission',
					'id'     => $post_id,
					'type'   => 'approve',
				],
					admin_url() ); ?>" style="background:#135E96;border-radius:3px;color:#fff!important;font-size:11px;font-weight:600;padding:11px 10px;text-align:center;text-decoration:none;text-transform:uppercase;white-space:nowrap" target="_blank">Approve Submission</a>
            </td>
        </tr>
