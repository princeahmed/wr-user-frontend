...
<div id="report-form-wrapper" class="report-form-wrapper <?php echo $active; ?>">
    <form name="wp-radio-from report-form" class="report-form">
        ...
        <div class="report-before">
            <h3 class="form-message"><?php esc_html_e( 'Send us your Problem:', 'wp-radio' ); ?></h3>
            ...
            <p class="wp-radio-form-row report-submit-field">
                <button type="submit" id="report-submit" class="button report-submit"><?php esc_html_e( 'Send Message', 'wp-radio' ); ?></button>
            </p>

        </div>

        <div class="report-after">
            <h3 class="confirm-message"><?php printf(__( 'Your message has been sent. Thanks %s', 'wp-radio' ), '😊'); ?></h3>
        </div>
