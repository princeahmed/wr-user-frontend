...
<form class="wp-radio-form wp-radio-form-edit-account" method="post" enctype="multipart/form-data">
    ...
    <p class="wp-radio-form-row wp-radio-form-row--wide avatar-field">
        <label for="avatar"><?php esc_html_e( 'Avatar Image:', 'wp-radio-user-frontend' ); ?></label>
    ...
    <p class="wp-radio-form-row">
        ...
        <button type="submit" class="wp-radio-button button" name="submit"><?php esc_attr_e( 'Update', 'wp-radio-user-frontend' ); ?></button>
    </p>
