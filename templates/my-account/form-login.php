        ...
        <form class="wp-radio-form wp-radio-form-login" method="post">
            ...
            <p class="wp-radio-form-row wp-radio-form-row--wide">
                <label for="password"><?php esc_html_e( 'Password', 'wp-radio-user-frontend' ); ?>
                    &nbsp;<span class="required">*</span></label>
                <input class="wp-radio-input wp-radio-input--text" type="password" name="password" id="password" autocomplete="current-password"/>
            </p>
            ...
            <p class="wp-radio-form-row">
                ...
                <button type="submit" class="wp-radio-button button wp-radio-form-login__submit button" name="login" value="<?php esc_attr_e( 'Log in', 'wp-radio-user-frontend' ); ?>"><?php esc_html_e( 'Log in', 'wp-radio-user-frontend' ); ?></button>
            </p>
        ...
        <form method="post" class="wp-radio-form wp-radio-form-register register">
            ...
            <p class="wp-radio-form-row wp-radio-form-row--wide">
                <label for="reg_email"><?php esc_html_e( 'Email address', 'wp-radio-user-frontend' ); ?>
                    &nbsp;<span class="required">*</span></label>
                <input type="email" class="wp-radio-input wp-radio-input--text" name="email" id="reg_email" autocomplete="email" value="<?php echo ( ! empty( $_POST['email'] ) ) ? esc_attr( wp_unslash( $_POST['email'] ) ) : ''; ?>"/><?php // @codingStandardsIgnoreLine ?>
            </p>
            ...
            <p class="wp-radio-form-row">
                ...
                <button type="submit" class="wp-radio-button button" name="register" value="<?php esc_attr_e( 'Register', 'wp-radio-user-frontend' ); ?>"><?php esc_html_e( 'Register', 'wp-radio-user-frontend' ); ?></button>
            </p>
