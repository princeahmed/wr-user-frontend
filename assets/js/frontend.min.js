...
function Loop({
  ...
  useEffect(() => {
    window.wpRadioHooks.addAction('onPlay', 'wp-radio', id => {
      setPlaying(id);
      setBuffering(null);
    });
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "wp-radio-listing-wrap"
  }, items.map(item => {
    let {
      id,
      title,
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      locations: locations
    })), !isGrid && genres && /*#__PURE__*/React.createElement(_Genres__WEBPACK_IMPORTED_MODULE_2__["default"], {
      genres: genres
    })), !isGrid && /*#__PURE__*/React.createElement(_PlayBtn__WEBPACK_IMPORTED_MODULE_3__["default"], {
      isPlaying: isPlaying,
      isBuffering: isBuffering,
...
function PlayBtn({
  ...
  useEffect(() => {
    setTimeout(() => {
      playBtnRef && window.wpRadioHooks.doAction('playBtn', playBtnRef.current, data.id);
    }, 1);
  }, []);
  return /*#__PURE__*/React.createElement("div", {
    className: "play-btn",
...
function Location({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    href: city.link,
    className: "radio-country-link",
    onClick: e => handleClick(e, city.slug)
  }, city.name, ","), region && /*#__PURE__*/React.createElement("a", {
    href: region.link,
    className: "radio-country-link",
    onClick: e => handleClick(e, region.slug)
...
/*!*****************************************************!*\
  !*** ../wp-radio/assets/js/components/functions.js ***!
  \*****************************************************/
/*! exports provided: countryFlag, updateParam, updateURL */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _Review__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Review */ "./assets/js/components/Review.js");
...
function Hooks() {
  //favorite btn
  window.wpRadioHooks.addAction('playBtn', 'wp-radio', function (parent, id) {
    if (!parent) return;
    var btn = document.createElement('span');
    btn.classList.add('favorite-btn-wrap');
    wp.element.render( /*#__PURE__*/React.createElement(_FavoriteBtn__WEBPACK_IMPORTED_MODULE_0__["default"], null), btn);
    parent.prepend(btn);

    if (parent.classList.contains('wp-radio-player-controls')) {
      var _btn = document.createElement('span');

      _btn.classList.add('report-btn-wrap');
  ...
  window.wpRadioHooks.addAction('singleRadio', 'wp-radio', function (parent, info, contacts, id) {
    //report btn
    var reportBtn = document.createElement('span');
    reportBtn.classList.add('report-btn-wrap');
    wp.element.render( /*#__PURE__*/React.createElement(_ReportBtn__WEBPACK_IMPORTED_MODULE_1__["default"], null), reportBtn);
    info.append(reportBtn); //review

    var review = document.createElement('span');
    review.classList.add('wp-radio-review-wrap');
    wp.element.render( /*#__PURE__*/React.createElement(_Review__WEBPACK_IMPORTED_MODULE_2__["default"], null), review);
...
function Dashboard(_ref) {
  ...
  var userName = 'Prince';
  var logoutURL = '';
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", null, "Hello ", /*#__PURE__*/React.createElement("strong", null, userName), " (not ", /*#__PURE__*/React.createElement("strong", null, userName), "?", /*#__PURE__*/React.createElement("a", {
    href: logoutURL
    ...
    onClick: function onClick() {
      return setActive('favorites');
    }
  }, "favourite stations"), ", and ", /*#__PURE__*/React.createElement("a", {
    href: "#",
    onClick: function onClick() {
      return setActive('edit-account');
    }
...
function EditAccount() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h3", {
    ...
    className: "wp-radio-form-row wp-radio-form-row--wide avatar-field"
  }, /*#__PURE__*/React.createElement("label", {
    htmlFor: "avatar"
  }, "Avatar Image:"), /*#__PURE__*/React.createElement(FormFileUpload, {
    accept: "image/*",
...
function Favorites() {
  ...
  }, /*#__PURE__*/React.createElement(_wp_radio_assets_js_Listing_Loop__WEBPACK_IMPORTED_MODULE_0__["default"], {
    items: favorites
  })));
}
...
function MyAccount() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "wp-radio-notices"
  }), 'dashboard' === tab && /*#__PURE__*/React.createElement(_Dashboard__WEBPACK_IMPORTED_MODULE_1__["default"], null), 'favorites' === tab && /*#__PURE__*/React.createElement(_Favorites__WEBPACK_IMPORTED_MODULE_2__["default"], null), 'edit-account' === tab && /*#__PURE__*/React.createElement(_EditAccount__WEBPACK_IMPORTED_MODULE_3__["default"], null)));
}
var element = document.getElementById('wp-radio-account');

if (element) {
  wp.element.render( /*#__PURE__*/React.createElement(MyAccount, null), element);
}
...
/***/ "./assets/js/components/Review.js":
/*!****************************************!*\
  !*** ./assets/js/components/Review.js ***!
  \****************************************/
/*! exports provided: default */
...
function Review() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
  ...
  }, "What Others Say about ", title), reviews.map(function (_ref) {
    ...
    var icon = userRating && key <= userRating.rating ? 'filled' : 'empty';
    return /*#__PURE__*/React.createElement("i", {
      className: "dashicons star dashicons-star-".concat(icon)
    });
  }))), /*#__PURE__*/React.createElement("p", {
    ...
    type: "button",
    className: classnames__WEBPACK_IMPORTED_MODULE_0___default()("wp-radio-button button", {
      disabled: !!userID
    })
...
function SubmitStation() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    htmlFor: ""
  }, "Station Logo"), /*#__PURE__*/React.createElement(FormFileUpload, {
    accept: "image/*",
    onChange: function onChange(e) {
      return console.log('new image', e);
    },
    render: function render(_ref) {
      var openFileDialog = _ref.openFileDialog;
      return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", null, "Upload an image below: "), /*#__PURE__*/React.createElement("button", {
        type: "button",
        onClick: openFileDialog
      }, "Upload image"));
    }
...
if (element) {
  wp.element.render( /*#__PURE__*/React.createElement(SubmitStation, null), element);
}
